...
export const tokenSets: DesignTokens[] = [
  ...
  {
    // 8 · Noir Violet — evening aubergine glamour with lilac light; Playfair + Jost.
    "--color-bg": "#151019",
    "--color-surface": "#201826",
    "--color-text": "#F1EBF4",
    "--color-text-muted": "#A294AC",
    "--color-primary": "#C3A6D6",
    "--color-primary-contrast": "#181220",
    "--color-accent": "#DFCBEA",
    "--color-border": "#2E2438",
    "--font-heading": PLAYFAIR,
    "--font-body": JOST,
